...
const styles = {
  ...
  breadcrumbLink: { color: '#002D4C', textDecoration: 'none', cursor: 'pointer' },
  ...
  stepNumber: { width: '32px', height: '32px', backgroundColor: '#002D4C', color: '#ffffff', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 600, fontSize: '0.875rem', flexShrink: 0 },
  ...
  label: { display: 'block', fontSize: '0.75rem', color: '#002D4C', marginBottom: '0.25rem', fontWeight: 500 },
  labelRequired: { color: '#dc2626' },
  input: { width: '100%', padding: '0.75rem', fontSize: '0.875rem', border: 'none', borderBottom: '2px solid #002D4C', backgroundColor: 'transparent', outline: 'none', transition: 'border-color 0.2s ease' },
  inputError: { borderBottomColor: '#dc2626' },
  inputDisabled: { borderBottomColor: '#e5e7eb', backgroundColor: '#f8fafc', cursor: 'not-allowed' },
  select: { width: '100%', padding: '0.75rem', fontSize: '0.875rem', border: 'none', borderBottom: '2px solid #002D4C', backgroundColor: 'transparent', outline: 'none', cursor: 'pointer', appearance: 'none' as const },
  ...
  primaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.625rem 1.25rem', fontSize: '0.875rem', fontWeight: 500, color: '#ffffff', backgroundColor: '#002D4C', border: '1px solid #002D4C', borderRadius: '0.375rem', cursor: 'pointer', transition: 'all 0.2s ease' },
