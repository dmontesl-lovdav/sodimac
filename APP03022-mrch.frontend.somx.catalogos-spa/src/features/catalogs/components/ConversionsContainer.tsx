...
import { conversionService, catalogElementService } from '../../../services/api';
  ...
  return (
    <div style={S.container}>
      <div style={{ fontSize: '0.875rem', color: '#64748b', marginBottom: '1.5rem' }}>
        ...
        {' / '}
        <span style={{ color: '#0066CC', cursor: 'pointer', textDecoration: 'none' }} onClick={() => navigate('/catalogos/catalogs')}>Gestión de Catálogos</span>
        {' / '}
        <span style={{ color: '#0066CC', cursor: 'pointer', textDecoration: 'none' }} onClick={() => navigate('/catalogos/catalogs')}>Catálogos</span>
        {' / '}
      ...
      <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '1.5rem' }}>
        <button style={{ ...S.btn, ...S.primaryBtn }} onClick={() => navigate(`/catalogos/elementos/${elementId}/conversiones/nueva`)}>+ Nueva Conversión</button>
                ...
                {conversions.map((c: any) => (
                  <tr key={c.idConversion}>
                    ...
                    <td style={S.td}><button style={{ ...S.btn, ...S.ghostBtn, padding: '0.25rem', fontSize: '0.7rem' }}
                      onClick={() => navigate(`/catalogos/elementos/${elementId}/conversiones/editar/${c.idConversion}`)}>✏️</button></td>
