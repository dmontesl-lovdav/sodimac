...
import type { CatalogSimple, CatalogElement, CatalogElementCreateDto, CatalogElementUpdateDto } from '../../../services/api';
...
export default function ElementForm() {
  ...
  const executeSave = async () => {
    try {
      ...
      setTimeout(() => navigate(`/catalogos/catalogs/${id}/elementos`), 1500);
    } catch (error: any) {
  ...
  const handleBack = () => {
    ...
    else navigate(`/catalogos/catalogs/${id}/elementos`);
  };
  ...
  return (
    <div style={styles.container}>
      <div style={styles.breadcrumb}>
        ...
        <span style={styles.breadcrumbLink} onClick={() => navigate('/catalogos/catalogs')}>Gestión de Catálogos</span>{' / '}
        <span style={styles.breadcrumbLink} onClick={() => navigate(`/catalogos/catalogs/${id}/elementos`)}>Elementos</span>{' / '}
        ...
        <div style={styles.modal}>
          <div style={styles.modalContent}>
            ...
            <div style={styles.modalButtons}>
              ...
              <button style={styles.primaryBtn} onClick={() => { setShowExitModal(false); navigate(`/catalogos/catalogs/${id}/elementos`); }}>Sí</button>
            </div>
          </div>
        </div>
      )}
