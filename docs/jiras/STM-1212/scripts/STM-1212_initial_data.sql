-- =====================================================
-- STM-1212: Script de Carga Inicial de Datos
...
-- Tipos de mensaje: 1=Error, 2=Warning, 3=Info, 4=Success
-- =====================================================
...
SELECT id_message, 1, 1, CURRENT_TIMESTAMP FROM core_utils.cat_message; -- Portal Web

INSERT INTO core_utils.application_msg (id_message, id_application, created_by, created_at)
SELECT id_message, 2, 1, CURRENT_TIMESTAMP FROM core_utils.cat_message; -- API REST

INSERT INTO core_utils.application_msg (id_message, id_application, created_by, created_at)
SELECT id_message, 3, 1, CURRENT_TIMESTAMP FROM core_utils.cat_message WHERE message_code LIKE 'ERR%' OR message_code LIKE 'SUC%'; -- Batch (solo errores y exitos)
...
-- Parametros del modulo FISCAL (id_module=1)
...
-- Parametros del modulo FINANZAS (id_module=2)
...
-- Parametros del modulo NOTIFICACIONES (id_module=7)
...
-- Parametros del modulo SEGURIDAD (id_module=5)
...
-- Parametros del modulo REPORTES (id_module=6)
...
UNION ALL
SELECT 'cat_item_type', COUNT(*) FROM core_utils.cat_item_type
UNION ALL
SELECT 'cat_item', COUNT(*) FROM core_utils.cat_item
UNION ALL
SELECT 'cat_process', COUNT(*) FROM core_utils.cat_process
UNION ALL
SELECT 'cat_message', COUNT(*) FROM core_utils.cat_message
UNION ALL
SELECT 'application_msg', COUNT(*) FROM core_utils.application_msg
UNION ALL
SELECT 'cat_parameter', COUNT(*) FROM core_utils.cat_parameter;

-- =====================================================
-- FIN DEL SCRIPT DE CARGA INICIAL
-- =====================================================
