...
$(document).ready(function () {
    ...
    $('#rootwizard').bootstrapWizard({
        ...
        'onNext': function(tab, navigation, index) {
            ...
            if($validator.isValid()){
            	...
            	if (index == 1){
            		...
            		if (numItems == 0) {
                		var result = validameTicket('ticketHolder', '#ticketHolder', 'messajeTicketCompra', '1')
                		if (!result) {
                			return false;
                		}
                		eliminacionClases("loquesea");            			
            		}
        ...
        'onPrevious': function(tab, navigation, index) {
        	...
        	{
        		$("#btnAgregar").addClass("btn-Agregavisible");
        		$("#btnFirstNext").removeClass("btn-Agregavisible");        		
        	}
