...
select * from catdispositivos c where idEquipo= '94FB2962AC6B'
...
select uspExistingDispositivo('1040001','94-FB-29-62-AC-6B','94FB2962AC6B','PDA PREVENCION', 1);

SELECT * 
FROM catdispositivos 
WHERE descripcionDispositivo = 'PDA PREVENCION'
