...
public class QueryWsRepository {
	
	private static Logger logger = LoggerFactory.getLogger(QueryWsRepository.class);
	...
	private static Object executeGetResult(String sql, EQuery enumQuery) {
		...
		do {
			try {
				...
				EntityManager em = new EntityManagerWsRepository().getEntityManager();
