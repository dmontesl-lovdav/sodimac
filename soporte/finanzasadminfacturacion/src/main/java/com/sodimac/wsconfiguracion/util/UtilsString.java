...
public class UtilsString {
	...
	public static String parseActivityDesc(int idActividad, List<String> textoArr, String descripcion) {
	...
	public static String convertirCaracteresXml(String texto) {
		String result = texto.replace("&amp;", "&").replace("&", "&amp;").replace("Ñ", "&#209;").replace("\"", "&quot;").replace("'", "&apos;").replace("<", "&lt;").replace(">", "&gt;");
		return result;	
	}
