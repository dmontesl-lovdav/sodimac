...
import { catalogService, catalogElementService, CatalogResponse, CatalogElementSearchParams, CatalogSimple } from '../../../services/api';
    ...
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.sectionDescription}>
          ...
          <div style={styles.buttonsGroup}>
            <button
              ...
              onClick={() => navigate(`/catalogos/catalogs/${id}/elementos/importar`)}
            >
              ⬇ Importar Elementos
            </button>
            <button
              style={styles.primaryBtn}
              onClick={() => navigate(`/catalogos/catalogs/${id}/elementos/nuevo`)}
            >
              ⊕ Nuevo Elemento
            </button>
          </div>
                    ...
                    <tr key={el.id}>
                      ...
                      <td style={styles.td}>
                        <button
                          ...
                          onClick={() => navigate(`/catalogos/elementos/${el.id}/conversiones`)}
                        >
                          <ViewIcon />
                        </button>
                      </td>
                      <td style={styles.td}>
                        <button
                          style={styles.actionBtn}
                          title="Editar"
                          onClick={() => navigate(`/catalogos/catalogs/${id}/elementos/editar/${el.id}`)}
                        >
                          <EditIcon />
                        </button>
                      </td>
        ...
        <div style={{ ...styles.footer, justifyContent: 'flex-end' }}>
          ...
          <span style={styles.ghostBtn} onClick={() => navigate('/catalogos/catalogs')}>
            Volver
          </span>
