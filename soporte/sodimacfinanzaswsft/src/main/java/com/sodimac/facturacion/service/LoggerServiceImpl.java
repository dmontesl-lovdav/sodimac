...
import com.sodimac.facturacion.repository.fac.LogErroresRepository;
...
public class LoggerServiceImpl implements LoggerService {
	...
	public void guardarLog(Object obj, ClientesTemporalModel model, String longitud, String latitud, String explorador,
		...
		if (obj.getClass().getName().endsWith("RespuestaXml")) {
			...
			String folio = "";
			String facturaId = "";			
			if (model.getVersionFacturacionSat().equals("4.0")) {
				com.sodimac.facturacion.clientews.wcfemision40.org.datacontract.schemas._2004._07.cfdiwcfemisionservicio40_sodimac.RespuestaXml result = (com.sodimac.facturacion.clientews.wcfemision40.org.datacontract.schemas._2004._07.cfdiwcfemisionservicio40_sodimac.RespuestaXml) obj;
				estatusId = result.getEstatusId() == null? "":result.getEstatusId().toString();
				errorMessage = result.getErrorMessage() == null? "":result.getErrorMessage().toString();
				errorDesc = result.getErrorDesc() == null? "":result.getErrorDesc().toString();
				folio = result.getFolio() == null? "":result.getFolio().toString();
				facturaId = result.getFacturaId() == null? "":result.getFacturaId().toString();			
			} else {
				RespuestaXml result = (RespuestaXml) obj;
				estatusId = result.getEstatusId() == null? "":result.getEstatusId();
				errorMessage = result.getErrorMessage() == null? "":result.getErrorMessage();
				errorDesc = result.getErrorDesc() == null? "":result.getErrorDesc();
				folio = result.getFolio() == null? "":result.getFolio();
				facturaId = result.getFacturaId() == null? "":result.getFacturaId();				
			}
		...
		if (obj.getClass().getName().endsWith("cfdiwcfemisionservicio40_sodimac.Resultado")) {
			...
			com.sodimac.facturacion.clientews.wcfemision40.org.datacontract.schemas._2004._07.cfdiwcfemisionservicio40_sodimac.Resultado result = (com.sodimac.facturacion.clientews.wcfemision40.org.datacontract.schemas._2004._07.cfdiwcfemisionservicio40_sodimac.Resultado) obj;
			estatusId = "";
			errorMessage = result.getErrorMessage() == null? "":result.getErrorMessage().toString();
			errorDesc = result.getErrorDesc() == null? "":result.getErrorDesc().toString();
			folio = result.getFolio() == null? "":result.getFolio().toString();
	...
	@Override
	@Transactional
	public void guardarLog(Object obj, CompTemporalModel model, String longitud, String latitud, String explorador,
			String sistemaOper, String ip, String ticket, String rfc, String pagina, String xml, int idFacturaPac, String sessionId) {
