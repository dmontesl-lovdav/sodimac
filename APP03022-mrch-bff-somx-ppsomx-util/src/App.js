...
const remoteUrl    = process.env.REMOTE_URL    || 'http://localhost:3712';
...
localService.listen(localPort, () => {
    ...
    logger.info(`ACCEPTING NEW REQUEST ${request.method}: ${request.originalUrl} - STATUS: ${response.statusCode}`);
});
