# STM-323: Aplicar filtro de seguridad de información en la opción de facturas por atributo de usuario

> **Enlace JIRA**: https://jira.falabella.tech/browse/STM-323
...
- El backend debe filtrar la información de las facturas de acuerdo con los atributos asignados al usuario autenticado.
...
Los atributos que deben utilizarse para el filtrado de facturas son:
- Proveedor
- TipoProveedor
- GrupoProveedor
