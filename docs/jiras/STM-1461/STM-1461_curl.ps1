# STM-1461 — Carta Porte — Pruebas filtro seguridad (PowerShell)
...
function Invoke-Tests {
    ...
    Write-Host "=========================================="
    try {
        $res = Invoke-WebRequest -Uri "$BaseApi/shipping-guide?$Params" -Headers $Headers -Method GET -UseBasicParsing
...
Invoke-Tests "ESCENARIO 5: Spoof intentado (debe ignorarse)" @{
