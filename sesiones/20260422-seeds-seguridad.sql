-- ============================================================================
-- Seeds Modulo Seguridad (catalogos morado)
-- shared_catalogs: catalog_header + catalog_detail + dictionary_lang
--                + catalog_detail_relation (FKs Aplicativo->Modulo, Evento->Aplicativo)
--
-- Fuente: sesiones/Catálogos (2).xlsx
-- Idiomas: 1=ES  2=EN  3=PT
-- dict_id range: 10001-10088 (por encima del max actual: 8033)
--
-- Idempotente: borra por codigo exacto antes de reinsertar.
-- ============================================================================
