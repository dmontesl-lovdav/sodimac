...
import { catalogService, CatalogResponse } from '../../../services/api';
        ...
        <div style={styles.card}>
          <div style={styles.headerContent}>
            ...
            <button
              ...
              onClick={() => navigate('/catalogos/catalogs/crear')}
            >
          ...
          {!hasSearched ? (
            ...
            <>
                      ...
                      <tr key={catalog.id}>
                        ...
                        <td style={styles.td}>
                          <button
                            ...
                            title="Ver"
                            onClick={() => navigate(`/catalogos/catalogs/${catalog.id}/elementos`)}
                          >
                        ...
                        <td style={styles.td}>
                          <button
                            style={styles.actionBtn}
                            title="Editar"
                            onClick={() => navigate(`/catalogos/catalogs/editar/${catalog.id}`)}
                          >
              ...
              <div style={styles.footer}>
                ...
                <button style={styles.ghostBtn} onClick={() => navigate('/catalogos')}>
                  Volver
                </button>
              </div>
            </>
