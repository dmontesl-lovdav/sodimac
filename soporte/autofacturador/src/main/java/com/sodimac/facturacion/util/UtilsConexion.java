...
public class UtilsConexion {
	...
	public static EntityManagerFactory buildFactory(String propertiesConexion) {
		...
		settings.put("hibernate.connection.url", prop.getProperty("jdbc." + tipoConexion + ".url"));
		settings.put("hibernate.connection.username", prop.getProperty("jdbc." + tipoConexion + ".user"));
		settings.put("hibernate.connection.password", prop.getProperty("jdbc." + tipoConexion + ".pass"));
