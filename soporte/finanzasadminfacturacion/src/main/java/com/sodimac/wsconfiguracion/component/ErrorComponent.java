package com.sodimac.wsconfiguracion.component;
...
import com.sodimac.wsconfiguracion.service.LoggerService;
...
//		loggerService.guardarLog(obj, model, longitud, latitud, explorador, sistemaOper, ip, ticket, rfc, pagina, xml, idFacturaPac, sessionId, parametrosLlamado);
//	}
	
	public void guardarLog (Object obj) {
		loggerService.guardarLog(obj, longitud, latitud, explorador, sistemaOper, ip, ticket, rfc, pagina, xml, idFacturaPac, sessionId, parametrosLlamado);
	}
