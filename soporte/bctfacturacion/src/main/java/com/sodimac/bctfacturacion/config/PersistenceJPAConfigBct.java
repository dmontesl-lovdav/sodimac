...
@EnableJpaRepositories(
			basePackages = "com.sodimac.bctfacturacion.repository.bct",
...
public class PersistenceJPAConfigBct {
	...
	@Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBct() {
        LocalContainerEntityManagerFactoryBean entityManagerFactoryBean = new LocalContainerEntityManagerFactoryBean();
        entityManagerFactoryBean.setDataSource( dataSourceBct() );
        entityManagerFactoryBean.setPackagesToScan(new String[] { "com.sodimac.bctfacturacion.entity.bct" });
    ...
    @Bean
    public DataSource dataSourceBct() {
        DriverManagerDataSource dataSource = new DriverManagerDataSource();
        dataSource.setDriverClassName(env.getProperty("jdbc.bct.driverClassName"));
        dataSource.setUrl( seguridadService.desencriptar( env.getProperty("jdbc.bct.url") ));
        dataSource.setUsername( seguridadService.desencriptar( env.getProperty("jdbc.bct.user") ));
        dataSource.setPassword( seguridadService.desencriptar( env.getProperty("jdbc.bct.pass") ));
        return dataSource;
    }

    @Bean
    public PlatformTransactionManager transactionManagerBct() {
