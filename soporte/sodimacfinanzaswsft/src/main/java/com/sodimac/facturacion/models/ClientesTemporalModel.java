...
public class ClientesTemporalModel extends CodigoError {
	...
	private DescuentosRebatesModel rebate;
	...
	public Integer getIdUsoCfdiReal() {
		return idUsoCfdiReal;
	}

	public void setIdUsoCfdiReal(Integer idUsoCfdiReal) {
		this.idUsoCfdiReal = idUsoCfdiReal;
	}
	...
	public DescuentosRebatesModel getRebate() {
		return rebate;
	}

	public void setRebate(DescuentosRebatesModel rebate) {
		this.rebate = rebate;
	}
	...
	public String toString() {
		return "ClientesTemporalModel [id=" + id + ", rfc=" + rfc + ", ticket=" + ticket + ", razonSocial="
				...
				+ uuidRelacionado + ", emailCC=" + emailCC + ", subTotal=" + subTotal + ", serie=" + serie + ", folio="
				+ folio + ", idOrigen=" + idOrigen + ", rebate=" + rebate + ", regimenFiscal=" + regimenFiscal
				+ ", codigoPostal=" + codigoPostal + ", pais=" + pais + ", comercio=" + comercio + ", canal=" + canal
				+ ", idAplicacion=" + idAplicacion + ", getId()=" + getId() + ", getRfc()=" + getRfc()
				+ ", getTicket()=" + getTicket() + ", getRazonSocial()=" + getRazonSocial() + ", getIdUsoCfdi()="
				+ getIdUsoCfdi() + ", getMetodoPago()=" + getMetodoPago() + ", getEmail()=" + getEmail()
				+ ", isActivo()=" + isActivo() + ", getFechaCreacion()=" + getFechaCreacion()
				+ ", getAutorizoGuardado()=" + getAutorizoGuardado() + ", getPac()=" + getPac() + ", getIdFacturaPac()="
				+ getIdFacturaPac() + ", getUuid()=" + getUuid() + ", getFechaTimbrado()=" + getFechaTimbrado()
				+ ", getVersionFacturacionSat()=" + getVersionFacturacionSat() + ", getXml()=" + getXml()
				+ ", getFechaCompra()=" + getFechaCompra() + ", getIdEstatusFactura()=" + getIdEstatusFactura()
				+ ", getNombreEstatus()=" + getNombreEstatus() + ", getNombreArchivo()=" + getNombreArchivo()
				+ ", getTicketBct()=" + getTicketBct() + ", getVersionFactura()=" + getVersionFactura()
				+ ", getTransaccion()=" + getTransaccion() + ", getIdActividad()=" + getIdActividad()
				+ ", getActividadDescripcion()=" + getActividadDescripcion() + ", getIdUsuario()=" + getIdUsuario()
				+ ", getLongitud()=" + getLongitud() + ", getLatitud()=" + getLatitud() + ", getPagina()=" + getPagina()
				+ ", getExplorador()=" + getExplorador() + ", getSistemaOperativo()=" + getSistemaOperativo()
				+ ", getIp()=" + getIp() + ", getChecked()=" + getChecked() + ", getTotal()=" + getTotal()
				+ ", getNombreObra()=" + getNombreObra() + ", getResponsableObra()=" + getResponsableObra()
				+ ", getIdComprobante()=" + getIdComprobante() + ", getUuidRelacionado()=" + getUuidRelacionado()
				+ ", getEmailCC()=" + getEmailCC() + ", getSubTotal()=" + getSubTotal() + ", getSerie()=" + getSerie()
				+ ", getFolio()=" + getFolio() + ", getRebate()=" + getRebate() + ", getIdOrigen()=" + getIdOrigen()
				+ ", getRegimenFiscal()=" + getRegimenFiscal() + ", getCodigoPostal()=" + getCodigoPostal()
				+ ", getPais()=" + getPais() + ", getComercio()=" + getComercio() + ", getCanal()=" + getCanal()
				+ ", getIdAplicacion()=" + getIdAplicacion() + ", getError()=" + getError() + ", getClass()="
