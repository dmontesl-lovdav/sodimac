...
-- Daniela Goucen Davila 				-- dgoucend@sodimac.com.mx
-- Dulce Carolina Garcia Acametitla		-- dcgarciaa@sodimac.com.mx
...
insert into usuario values (53,'g_dco018@sodimac.com.mx','MDAwMDAwMDAwMDAwMDAwMOouTHczB6tek7OpJNENjRU=','Daniela', 'Goucen', 'Davila', getdate(),null,1,0);
insert into usuario values (54,'g_dco018@sodimac.com.mx','MDAwMDAwMDAwMDAwMDAwMOouTHczB6tek7OpJNENjRU=','Dulce Carolina', 'Garcia', 'Acametitla', getdate(),null,1,0);
insert into usuario values (55,'g_dco018@sodimac.com.mx','MDAwMDAwMDAwMDAwMDAwMOouTHczB6tek7OpJNENjRU=','Brenda Lizbeth', 'Arango', 'Chavez', getdate(),null,1,0);

-- 42XKGJ95
update usuario set usuario ='barangoc@sodimac.com.mx'  where id = 55;
...
select * from CatUsuarioPerfil where idUsuario in (34);
...
insert into CatUsuarioPerfil values (47,11,getdate(),null);
insert into CatUsuarioPerfil values (53,1,getdate(),null);
insert into CatUsuarioPerfil values (54,1,getdate(),null);
insert into CatUsuarioPerfil values (55,1,getdate(),null);
...
select count(1)
from vw_reporte_usuario_fillrate 
where FechaRecepcion>= CONVERT(DATETIME, '2025-08-01', 103) 
-- and FechaRecepcion<= CONVERT(DATETIME, '2025-08-30', 103)
-- and CalculoFinanzas=1
and calculoLogistica = 1

select top 100 *
from CalculoRebateFillRate
