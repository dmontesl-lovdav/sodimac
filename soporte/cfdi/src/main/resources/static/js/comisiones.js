...
$(document).ready(function(){
    ...
    $.ajax({
    	url: url,
    	data: {NombreCampo:"date.interval.comisiones"},
    ...
    var url = '/cfdi/comisiones/obtenerTiendas';
    $.ajax({
    	url: url,
...
function consultarOnClick() {
	...
	var url = './listarComisiones?dateDesde='+dateDesdeValue+'&dateHasta='+dateHastaValue+'&pageNumber=0'+'&start=0' + '&rowsPerPage=' + rowsPerPage + '&pTienda=' + cTienda + '&pTicket=' + ticket;
...
function descargaxlsxOnClick() {
	...
	var url = './listarComisiones/descargaXlsx?dateDesde='+dateDesdeValue+'&dateHasta='+dateHastaValue+'&pTienda=' + cTienda +'&pTicket=' + ticket;
