...
public class BodyClienteTemporalTYPE {
	...
	public String toString() {
		return "ClientesTemporalModel [id=" + id + ", rfc=" + rfc + ", ticket=" + ticket + ", razonSocial="
				...
				+ ", fechaCreacion=" + fechaCreacion + ", autorizoGuardado=" + autorizoGuardado + ", pac=" + pac
				+ ", idFacturaPac=" + idFacturaPac + ", uuid=" + uuid + ", fechaTimbrado=" + fechaTimbrado
				+ ", versionFacturacionSat=" + versionFacturacionSat + ", fechaCompra=" + fechaCompra
				+ ", idEstatusFactura=" + idEstatusFactura + ", nombreEstatus=" + nombreEstatus + ", nombreArchivo="
				+ nombreArchivo + ", ticketBct=" + ticketBct + ", versionFactura=" + versionFactura + ", transaccion="
				+ transaccion + ", idActividad=" + idActividad + ", actividadDescripcion=" + actividadDescripcion
				+ ", idUsuario=" + idUsuario + ", longitud=" + longitud + ", latitud=" + latitud + ", pagina=" + pagina
				+ ", explorador=" + explorador + ", sistemaOperativo=" + sistemaOperativo + ", ip=" + ip + ", checked="
				+ checked + ", total=" + total + ", nombreObra=" + nombreObra + ", responsableObra=" + responsableObra
				+ ", idComprobante=" + idComprobante + ", uuidRelacionado=" + uuidRelacionado 
				+ ", codigoPostal=" + codigoPostal + ", regimenFiscal=" + regimenFiscal + "]";
	}
}
