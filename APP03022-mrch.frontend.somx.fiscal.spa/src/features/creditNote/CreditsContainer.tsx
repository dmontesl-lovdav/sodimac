...
const columns: DataGridColumn<CreditNote>[] = [
  ...
  { header: "UUID", accessor: r => r.fiscalUuid ?? r.invoiceUuid ?? "--", exportAccessor: r => r.fiscalUuid ?? r.invoiceUuid },
  { header: "UUID Factura", accessor: r => (r.relatedInvoiceUuid != null && r.relatedInvoiceUuid !== "" ? String(r.relatedInvoiceUuid) : r.invoiceUuid) ?? "--", exportAccessor: r => (r.relatedInvoiceUuid != null && r.relatedInvoiceUuid !== "" ? String(r.relatedInvoiceUuid) : r.invoiceUuid) },
