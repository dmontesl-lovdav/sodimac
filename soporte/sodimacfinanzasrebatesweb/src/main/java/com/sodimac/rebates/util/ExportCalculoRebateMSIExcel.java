...
public class ExportCalculoRebateMSIExcel {

	private static Logger logger = LoggerFactory.getLogger(ExportCalculoRebateMSIExcel.class);
...
//		try (Workbook workbook = new XSSFWorkbook()) {
		try (SXSSFWorkbook workbook = new SXSSFWorkbook(10000)) {
			Sheet sheet = workbook.createSheet("Reporte Calculo Rebate MSI");
