...
public class QueryFisRepository {
	
	private static Logger logger = LoggerFactory.getLogger(QueryFisRepository.class);
	...
	private static Object executeGetResult(String sql, EQuery enumQuery) {
		...
		do {
			try {
				...
				EntityManager em = new EntityManagerFisRepository().getEntityManager();
