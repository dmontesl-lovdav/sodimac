...
import { supplierBlockService, SupplierBlock } from '../../../services/api';
    ...
    <div className="somx-container">
      ...
      <div className="somx-page-header">
        ...
        <button
          ...
          onClick={() => navigate('/catalogos/bloqueos/crear')}
        >
          + Nuevo Bloqueo
        </button>
      </div>
                        ...
                        <td>
                          <div className="somx-flex somx-gap-sm">
                            <button
                              ...
                              onClick={() => navigate(`/catalogos/bloqueos/editar/${block.id}`)}
                            >
                              Editar
                            </button>
                            <button
