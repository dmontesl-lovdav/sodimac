...
@Service
public class CalculoRebateMSIService implements ICalculoRebateMSIService {
	...
	public List<CalculoRebateMSIEntity> getCalculoRebateMSI(CalculoRebateMSI calculoRebateMSI) {
		List<CalculoRebateMSIEntity> list = null;
		CriteriaBuilder cb = em.getCriteriaBuilder();
		CriteriaQuery<CalculoRebateMSIEntity> cq = cb.createQuery(CalculoRebateMSIEntity.class);
		Root<CalculoRebateMSIEntity> oc = cq.from(CalculoRebateMSIEntity.class);
	...
	public List<CalculoRebateMSIDto> getCalculoRebateMSIView(CalculoRebateMSI calculoRebateMSI) throws ParseException {
		...
		sbQry.append("  UNION ALL  \n")
				...
				.append("      ,[FechaExclusion] \n") 			// --35
				.append("      ,[IdExclusion] \n") 				// --36
				.append("  FROM [CalculoRebateMSITemp]  \n")
				.append(" WHERE 1=1 \n");
