...
function messageDanger(id,descriptionMessage){
	...
	console.log("[FOLIOS - ERROR] Mostrando mensaje de error:");
	console.log("[FOLIOS - ERROR] - Contenedor:", id);
	console.log("[FOLIOS - ERROR] - Mensaje:", descriptionMessage);
...
function validarRangoMaximoFechas(idDateDesde, idDateHasta) {
	...
	var diasDiferencia = Math.floor((dateH.getTime() - dateD.getTime()) / 86400000);
	var diasMaximo = parseInt(periodo);  // CORREGIDO: Usar periodo directamente, no periodo-1
	var result = diasDiferencia > diasMaximo;

	// LOGS DE EVIDENCIA - INICIO
	console.log("[FOLIOS - RANGO FECHAS] Validando rango máximo de fechas:");
	console.log("[FOLIOS - RANGO FECHAS] - Fecha Desde:", $("#" + idDateDesde).val(), "=>", dateD);
	console.log("[FOLIOS - RANGO FECHAS] - Fecha Hasta:", $("#" + idDateHasta).val(), "=>", dateH);
	console.log("[FOLIOS - RANGO FECHAS] - Días de diferencia:", diasDiferencia);
	console.log("[FOLIOS - RANGO FECHAS] - Días máximo permitido:", diasMaximo);
	console.log("[FOLIOS - RANGO FECHAS] - Período configurado desde BD:", periodo);
	console.log("[FOLIOS - RANGO FECHAS] - ¿Excede el rango? (diasDiferencia > diasMaximo):", result);
	// LOGS DE EVIDENCIA - FIN
