...
COMMENT ON COLUMN invoice.accounting_date IS 'Fecha de contabilización. Se guarda cuando el estatus cambia a 7 (Pendiente de Pago) - STM-410';

-- Crear índice para búsquedas por fecha de contabilización
CREATE INDEX IF NOT EXISTS idx_invoice_accounting_date ON invoice(accounting_date);
