...
CREATE TABLE tenant_finance.finanzas_payment_headers (
	...
	CONSTRAINT uq_finanzas_payment_headers_group UNIQUE (company, anio, vendor_number, currency, payment_date)
);
CREATE INDEX idx_finanzas_payment_headers_company_anio ON tenant_finance.finanzas_payment_headers USING btree (company, anio);
CREATE INDEX idx_finanzas_payment_headers_vendor_payment_date ON tenant_finance.finanzas_payment_headers USING btree (vendor_number, payment_date);
...
-- tenant_finance.payment_detail definition

-- Drop table

-- DROP TABLE tenant_finance.payment_detail;

CREATE TABLE tenant_finance.payment_detail (
	...
	CONSTRAINT fk_finanzas_payments_header FOREIGN KEY (id_referencia_pago) REFERENCES tenant_finance.finanzas_payment_headers(id_referencia_pago)
);
CREATE INDEX idx_finanzas_payments_date ON tenant_finance.payment_detail USING btree (payment_date);
CREATE INDEX idx_finanzas_payments_document ON tenant_finance.payment_detail USING btree (document_number);
CREATE INDEX idx_finanzas_payments_id_referencia_pago ON tenant_finance.payment_detail USING btree (id_referencia_pago);
CREATE INDEX idx_finanzas_payments_sap_doc ON tenant_finance.payment_detail USING btree (sap_document);
CREATE INDEX idx_finanzas_payments_status ON tenant_finance.payment_detail USING btree (status);
CREATE INDEX idx_finanzas_payments_vendor ON tenant_finance.payment_detail USING btree (vendor_number);
