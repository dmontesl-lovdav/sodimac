...
public class ComprobanteDto {
	...
	public ComprobanteDto(String version, ConfDatosEmisorDto emisorNode, ConfDatosEmisorTiendaDto lugarExpedicion, ConfFormaMetodoPagoEntity relacion) {
		...
		if (relacion != null) {
			this.metodoPago = relacion.getCatMetodoPagoEntity() != null && relacion.getCatMetodoPagoEntity().getIdMetodoPago() != null ? relacion.getCatMetodoPagoEntity().getIdMetodoPago() : "N/A";
			this.formaPago = relacion.getCatFormaPagoEntity() != null && relacion.getCatFormaPagoEntity().getIdFormaPago() != null ? relacion.getCatFormaPagoEntity().getIdFormaPago() : "N/A";
		}
	}
