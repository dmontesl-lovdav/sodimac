# STM-1461: Aplicar filtro de seguridad de información en la opción de carta porte por atributo de usuario

> **Enlace JIRA**: https://jira.falabella.tech/browse/STM-1461
...
- El backend debe filtrar la información de las guías de carta porte de acuerdo con los atributos asignados al usuario autenticado.
...
Los atributos que deben utilizarse para el filtrado de carta porte son:
- Proveedor
- GrupoProveedor
...
- Dado un usuario autenticado con atributos configurados
  Cuando consulta las guías de embarque
