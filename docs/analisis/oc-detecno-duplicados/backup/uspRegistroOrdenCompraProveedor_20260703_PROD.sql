-- ============================================================
-- RESPALDO / ROLLBACK — SP uspRegistroOrdenCompraProveedor
...
-- USO: si el SP reescrito (03-usp-rewrite.sql) falla, restaurar con este
--      (cambiar CREATE por ALTER, o DROP + CREATE).
-- ============================================================
