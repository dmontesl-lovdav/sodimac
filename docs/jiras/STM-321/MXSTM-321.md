# STM-321: Aplicar filtro de seguridad de información en la opción de three way match por atributo de usuario

> **Enlace JIRA**: https://jira.falabella.tech/browse/STM-321
...
- El backend debe filtrar la información del three way match de acuerdo con los atributos asignados al usuario autenticado.
...
Los atributos que deben utilizarse para el filtrado del three way match son:
- Proveedor
- TipoProveedor
- GrupoProveedor
...
- Dado un usuario autenticado con atributos configurados
  Cuando consulta el three way match
