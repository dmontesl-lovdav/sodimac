-- ============================================================================
-- UTILS-API - Script Consolidado de Datos (Inserts)
-- Esquema: core_utils
-- Descripcion: Script unificado para insertar todos los datos del modulo utils
-- Fecha: 2025-12-22
--
...
-- Portal Web (aplicativo 1) - todos los mensajes
...
ON CONFLICT (id_message, id_application) DO NOTHING;

-- API REST (aplicativo 2) - todos los mensajes
INSERT INTO core_utils.application_msg (id_message, id_application, created_by, created_at)
SELECT id_message, 2, 1, CURRENT_TIMESTAMP FROM core_utils.cat_message
ON CONFLICT (id_message, id_application) DO NOTHING;

-- Batch (aplicativo 3) - solo errores y exitos
INSERT INTO core_utils.application_msg (id_message, id_application, created_by, created_at)
