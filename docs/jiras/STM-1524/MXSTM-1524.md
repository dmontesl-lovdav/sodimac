# STM-1524: Aplicar filtro de seguridad de información en la opción del estado de cuenta por atributo de usuario

> **Enlace JIRA**: https://jira.falabella.tech/browse/STM-1524
...
El sistema debe implementar filtrado de información del estado de cuenta a nivel backend utilizando atributos de usuario configurados en catálogos.
...
- El backend debe filtrar la información del estado de cuenta de acuerdo con los atributos asignados al usuario autenticado.
...
Los atributos que deben utilizarse para el filtrado del estado de cuenta son:
- Proveedor
- TipoProveedor
- GrupoProveedor
...
- Dado un usuario autenticado con atributos configurados
  Cuando consulta el estado de cuenta
