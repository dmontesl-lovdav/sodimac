 ...
 * - indeterminate: muestra barra animada
 * - determinate: usa value/max y opcionalmente buffer
 */
export default function GenericLinearProgress({
    indeterminate = false,
    value = 0,
    max = 100,
    buffer,            // número en mismas unidades que value (opcional)
    fullWidth = false,
    className = '',
