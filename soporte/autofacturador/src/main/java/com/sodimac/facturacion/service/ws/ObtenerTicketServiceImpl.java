...
public class ObtenerTicketServiceImpl implements ObtenerTicketService {
	...
	public ClienteTicketObtenerExpRespTYPE getTicket(String ticket) {
		...
		url = catConfiguracionService.findParameterByKey("WebService.ObtenerTicket.Url");
    	country = catConfiguracionService.findParameterByKey("WebService.Sodimac.Pais");
		comercio = catConfiguracionService.findParameterByKey("WebService.Sodimac.Comercio");
		canal = catConfiguracionService.findParameterByKey("WebService.Sodimac.Canal");
